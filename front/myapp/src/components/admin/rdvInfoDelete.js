...
export function RdvDeleteAdmin(props){
    ...
    <Modal.Body>
        ...
        <Button variant="danger" onClick={()=>DeleteRdv_(props.rdvInfo)&props.isPlanning?window.location.replace('/planning'):window.location.replace('/patients')}>Supprimer</Button>
    </Modal.Body>
    </Modal>}
