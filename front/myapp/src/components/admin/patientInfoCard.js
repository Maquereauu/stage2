...
export function PatientInfoAdmin(props){
    ...
    <Modal.Body>
        <PatientInfo handleShowModalTraitementList={props.handleShowModalTraitementList} handleShowModalBilanList={props.handleShowModalBilanList} handleShowModalPhotosList={props.handleShowModalPhotosList} handleShowModalMedicList={props.handleShowModalMedicList} handleShowModalPlaiesList={props.handleShowModalPlaiesList} setPatientInfo={props.setPatientInfo} handleShowModalPatientUpdate={props.handleShowModalPatientUpdate} handleShowModalPatientDelete={props.handleShowModalPatientDelete} patientInfo={props.patientInfo}/>
    </Modal.Body>
    </Modal>}