...
export function PatientInfoAdmin(props){
    ...
    <Modal.Body>
        <PatientInfo handleShowModalTraitementList={props.handleShowModalTraitementList} handleShowModalPhotosList={props.handleShowModalPhotosList} setPatientInfo={props.setPatientInfo} handleShowModalPatientUpdate={props.handleShowModalPatientUpdate} handleShowModalPatientDelete={props.handleShowModalPatientDelete} patientInfo={props.patientInfo}/>
    </Modal.Body>
    </Modal>}